...
Cite this repository: https://doi.org/10.53053/NFXV1143
...
View _Spectrum's_ interactive [Autism Drug Tracker](https://www.spectrumnews.org/features/autism-drug-tracker/).
...
## Repository contents
`nct_scraper.py`: A Python file that collects data from ClinicalTrials.gov and downloads a .csv file with filtered results. It should be modified to match your desired goals.
...
`data-analysis/data_cleaning.ipynb`: An exploratory Jupyter notebook that was used to determine how the scraped data should be cleaned, using Pandas. It is not necessary to download or use this notebook.

`data-analysis/spectrum_story_analysis.ipynb`: An exploratory Jupyter notebook that was used to do a cursory analysis of the scraped data.

`datasets`: This folder contains all of the datasets that were generated by the _Spectrum_ newsroom while creating the drug tracker. Each file is a .csv filetype.
